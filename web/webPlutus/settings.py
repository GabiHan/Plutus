"""
Django settings for webPlutus project.
...
SECRET_KEY = 'django-insecure-r=_rfjc)9z$6q$g(ltw7+b2)d9%z$^#(#d_bbkdpa5g+s@%p2i'
...
NPM_BIN_PATH = "C:/Program Files/nodejs/npm"  # Adjust based on your actual path
